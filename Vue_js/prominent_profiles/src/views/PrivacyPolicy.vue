<template>
 ...
 <div id="privacy" class="privacy">
   ...
   <div>
    ...
    <ul>
      <li>Visit our website at <a :href="websiteURL">https://www.prominentprofiles.com</a>, or
        any website of ours that links to this privacy notice</li>
      <li>Engage with us in other related ways, including any sales, marketing, or events</li>
    </ul>
    <p>Questions or concerns? Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a :href="'mailto:' + emailAddress">info@prominentprofiles.com</a>.</p>
  </div>
    ...
    <h3>Cookie Policy</h3>
    <h3>Terms and Conditions EULA</h3>
    <h3>Return Policy Disclaimer</h3>
    <h3>Shipping Policy Acceptable Use Policy</h3>
    <h3>Settings</h3>

    <h2>What personal information do we process?</h2>
    <p>When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use. Learn more about <a :href="personalInfoLink">personal information you disclose to us</a>.</p>
    ...
    <h2>Want to learn more about what we do with any information we collect?</h2>
    <p>Review the <a :href="privacyNoticeLink">privacy notice in full</a>.</p>
  </div>
    ...
    <p>We may use cookies and similar tracking technologies (like web beacons and pixels) to
      access or store information. Upon visiting the site a Cookie Banner is displayed providing
      the option to reject the non-essential viewedProfiles cookie that enables the trending
      entities feature on the homepage. CSRF and Login Tokens are essential for operation. If you
      are unhappy with this, we ask you do not use Prominent Profiles.
    </p>
  </div>
   ...
   <div>
    ...
    <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at info@prominentprofiles.com.</p>

    <h2>9. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
    <p><strong>In Short:</strong> In some regions, such as the European Economic Area (EEA), United Kingdom (UK), and Switzerland, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time.</p>
...
export default {
  data () {
    return {
      dataSubjectAccessRequestLink: 'https://app.termly.io/notify/1d590376-aca3-409d-9aa1-c37903f6cea8',
      cookieNoticeLink: 'http://www.prominentprofiles.com/cookies'
    }
  }
}
</script>
